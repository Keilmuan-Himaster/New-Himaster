...
@section('content')
        ...
        <div class="page-content">
            <div class="card">
                ...
                @include('backend.inventaris.__form')
            </div>
        </div>
@endsection
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.input', function() {
            $('#exampleModalCenterTitle').html("Add inventaris");
        ...
        $('body').on('click', '.deleteProduct', function() {
            ...
            if (check == true) {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('inventaris.store') }}" + '/' + data_id,
        ...
        $('body').on('click', '.editProduct', function() {
            var data_id = $(this).data('id');
            $.get("{{ route('inventaris.index') }}" + '/' + data_id + '/edit', function(data) {
                $('#exampleModalCenterTitle').html("Edit inventaris");
                $('#saveBtn').val("edit");
